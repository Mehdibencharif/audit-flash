...
st.markdown("""
Bienvenue dans l'outil interactif d'audit flash énergétique. Ce formulaire vous permettra de prioriser vos critères à l'aide de la méthode **AHP** (Analytic Hierarchy Process), afin de recevoir un résumé personnalisé.
""")
